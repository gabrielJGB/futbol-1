...
const FieldContainer = ({ id }) => {
  ...
  return (
    <div class={"flex flex-col gap-1"}>
      ...
      <div class={`${darkMode.value ? "bg-[url('/fieldbg_dark.png')]" : "bg-[url('/fieldbg.png')]"} z-0 grid grid-cols-2 bg-repeat shadow-gray-950 md:h-[450px] h-[430px] relative rounded-lg  md:w-full w-[200vw]`}>
