    ...
    <div class={`flex flex-row items-center`}>
      ...
      <div class=" flex flex-col items-center justify-center ">
...

        {
          <div
            style={{
              backgroundImage: showFlags.value
                ? `url('https://api.promiedos.com.ar/images/country/${country_id}/1')`
                : "",
              backgroundColor: showFlags.value ? "" : (colors.color ?? "black"),
            ...
            {teamId === "igg" && !showFlags.value && (
              <div class={"absolute"}>
                <div
                  ...
                  class={`-z-100  rounded-t-[5px] ${isStarter ? "h-[8px] w-[32px]" : "h-[4px] w-[15px]"}`}
                ></div>
                <div
                  style={{ backgroundColor: colors.text_color }}
                  class={` ${isStarter ? "h-[16px] w-[32px]" : "h-[7px] w-[15px]"} `}
                ></div>
                <div
                  style={{ backgroundColor: colors.color }}
                  class={`  rounded-b-[5px] ${isStarter ? "h-[8px] w-[32px]" : "h-[4px] w-[15px]"}`}
                ></div>
              </div>
            )}
            <div
